...
export default function AllAnsweredTickets({ searchValue, searchFilter, setController }) {
  ...
  return <>
    ...
    <Suspense fallback={'loading...'}>
      <BaseTicketTable searchValue={searchValue}
                       ...
                       queryParameter={`&key=${searchFilter}&user=false&status=1${selectedOption ? `&agent=${selectedOption}` : ''}`} />
    </Suspense>
  </>;
};
